...
<body>
    ...
    <div class="container mt-5 mb-5 border border-info rounded">
        <h4 class="text-secondary  m-3">Eliminar Contrato</h4>
        ...
        <div class="d-flex justify-content-around  mt-5 mb-5">
            <a class="btn btn-outline-success" href="{{route('contrato.index')}}">Cancelar</a>
            <form action="{{route('contrato.eliminate', $contrato)}}" method="post">
                @csrf()
