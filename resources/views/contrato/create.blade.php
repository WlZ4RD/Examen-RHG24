...
<body>
    ...
    <div class="container mt-5 mb-5 border border-info rounded">
        <h4 class="text-secondary  m-3">Nuevo Contrato</h4>
        @if (count($errors) > 0)
        ...
        @endif
        <hr />
        <form class="mt-5 mb-3" action="{{route('contrato.store')}}" method="POST">
            @csrf
            <input type="hidden" name="personal_id" id="personal">
            <div class="form-group row">
                <label for="DNI" class="col-sm-2 col-form-label">DNI:</label>
                <div class="row col-sm-10">
                    <div class="col"> <input class="form-control mr-sm-2 " type="number" id="search" placeholder="Ingrese DNI para buscar..." aria-label="Search"></div>
                    <div class="col">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" id="Cargo" name="Cargo" required class="form-control ">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" id="Local" name="Local" required class="form-control ">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="date" id="Inicio" name="Inicio" required class="form-control ">
                </div>
            </div>
